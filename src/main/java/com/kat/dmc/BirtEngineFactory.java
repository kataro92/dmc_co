...
public class BirtEngineFactory implements FactoryBean, ApplicationContextAware, DisposableBean {
    ...
    private File strResolvedDirectory;
    ...
    public void setLogDirectory( org.springframework.core.io.Resource resource ){
        ...
        try {
            ...
            this.strResolvedDirectory = f ;
        } catch (IOException e) {
            throw new RuntimeException("Could not set log file for BIRT report");
        }
    }
    ...
    public IReportEngine getObject(){
        ...
        config.setLogConfig( null != this.strResolvedDirectory ? this.strResolvedDirectory.getAbsolutePath() : null  , this.logLevel);
        try {
